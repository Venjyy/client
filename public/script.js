// Modal para imágenes
// este script igual es conocido cono index.js (en la estructura basica de react)
// ya que es el script javascript del index.html
// pero para fines de esta pagina lo lammare script.js
